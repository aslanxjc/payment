...
def getQrcodeUrl(order_number,good_name,totalpay):
    ...
    #支付回调地址
    parameters['notify_url'] = 'http://xydapi.tederen.com/common/wxpay/notify_url/'
    #交易类型 选用NATIVE
    ...
    parameters['appid'] = 'wx566be73406574c97'

    parameters['mch_id'] = '1491310452'
...
if __name__ == "__main__":
    print getQrcodeUrl('12312312','test',20)
