...
class WxPayConf_pub(object):
    ...
    APPSECRET = "b02b78cf2ef7292e024a4fabec993c16"
    #受理商ID，身份标识
    MCHID = "1309194501"
    ...
    #=======【证书路径设置】=====================================
    #证书路径,注意应该填写绝对路径
    SSLCERT_PATH = "/root/xyd_release/xydian/common/weixinpay/apiclient_cert.pem"
    SSLKEY_PATH = "/root/xyd_release/xydian/common/weixinpay/apiclient_key.pem"
...
if __name__ == "__main__":
    ...
    trans.parameters["partner_trade_no"] = "12345678"  #商户订单号
    #trans.parameters["openid"] = "oZdoUwnlx6yaCKaS8u15Co2YoZT8"  #openid
    trans.parameters["openid"] = "oZdoUwp48osfpJkPRbkTbks_Agl8"  #openid
